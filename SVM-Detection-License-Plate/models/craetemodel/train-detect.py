...
from lib_detection import save_model, load_model, readShapes
from utils import image_files_from_folder, loss, augment_sample, labels2output_map
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-m", "--model", type=str, required=True, help="Path to previous model"
    )
    ...
    parser.add_argument(
        "-op", "--optimizer", type=str, default="Adam", help="Optmizer (default = Adam)"
    )
    parser.add_argument(
        "-lr",
        "--learning-rate",
